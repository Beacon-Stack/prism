...
function NotificationModal({ editing, onClose }: ModalProps) {
  ...
  return (
    <Modal onClose={onClose} width={560} innerStyle={{ padding: 24, gap: 20, overflowY: "auto" }}>
        {/* Header */}
...
export default function NotificationList() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900 }}>
      <PageHeader
        title="Notifications"
        description="Alerts for movie events via Discord, Slack, Telegram, Gotify, ntfy, Pushover, and more."
        docsUrl={DOCS_URLS.notifications}
        action={
          <button
            onClick={openCreate}
            style={{
