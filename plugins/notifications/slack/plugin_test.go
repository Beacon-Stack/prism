...
func TestNotify_Success(t *testing.T) {
	...
	n := &Notifier{
		cfg:    Config{WebhookURL: srv.URL, Username: "LuminarrBot", IconEmoji: ":movie_camera:"},
		client: srv.Client(),
	}
	...
	if gotPayload.Username != "LuminarrBot" {
		t.Errorf("username = %q, want LuminarrBot", gotPayload.Username)
	}
