...
- [x] **AI command palette** — Natural language commands via Cmd+K. Navigate, search, query library stats, grab movies with quality preferences, run tasks. State-modifying actions require explicit confirmation. Uses Claude Haiku. Shipped in v2.0.0.
