...
SELECT id, name, kind, enabled, settings, search_on_add, monitor, min_availability, quality_profile_id, library_id, created_at, updated_at FROM import_list_configs WHERE enabled = 1 ORDER BY name ASC
`
